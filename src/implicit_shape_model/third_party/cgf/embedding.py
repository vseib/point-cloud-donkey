...
flags.DEFINE_integer('output_dimension', 40, 'Dimension of learned features. Make sure this value matches that of the pretrained model.')
...
#    print 'Data Loaded'
    ...
    if FLAGS.evaluate:
        ...
        np.savez(FLAGS.output_file, data=x_anchor)
