...
#ifndef ISM3D_FEATURESVFH_H
#define ISM3D_FEATURESVFH_H
...
{
    /**
     * @brief The FeaturesVFH class
     * Computes features using the Viewpoint Feature Histogram descriptor.
     */
    class FeaturesVFH
            : public Features
    {
