...
namespace ism3d
{
    FeaturesSHOTGlobal::FeaturesSHOTGlobal()
    {
    }
    ...
    pcl::PointCloud<ISMFeature>::Ptr FeaturesSHOTGlobal::iComputeDescriptors(pcl::PointCloud<PointT>::ConstPtr pointCloud,
                                                                       ...
                                                                       pcl::search::Search<PointT>::Ptr search)
    {
        ...
        referenceFrames = centroid_frame;
    ...
    std::string FeaturesSHOTGlobal::getTypeStatic()
    {
        return "SHOT_GLOBAL";
    }

    std::string FeaturesSHOTGlobal::getType() const
    {
        return FeaturesSHOTGlobal::getTypeStatic();
    }
}
